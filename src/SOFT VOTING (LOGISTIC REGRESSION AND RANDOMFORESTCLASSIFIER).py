# CODE 6
# USING SOFT VOTING THAT IS LOGISTIC REGRESSION AND RANDOMFORESTCLASSIFIER WITH PARAMETERS from RandomSearchCV and GridSearchCV
...
# Use your already tuned parameters for the RF
voting_clf = VotingClassifier(
    estimators=[
        ('lr', LogisticRegression(max_iter=1000)),
        ('rf', RandomForestClassifier(n_estimators=433, max_depth=21, max_features='log2', min_samples_leaf=9, min_samples_split=5, bootstrap=True, )) # Use your tuned params gotten from GridSearchCV here
    ],
    voting='soft' # This is the magic part
)
